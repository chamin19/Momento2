...
class Events extends resource_js_1.Resource {
    ...
    list({ identifier, queryParams, overrides, }) {
        return super._list({
            queryParams,
            path: (0, utils_js_1.makePathParams)('/v3/grants/{identifier}/events', { identifier }),
            overrides,
        });
    }
    /**
    ...
    listImportEvents({ identifier, queryParams, overrides, }) {
        return super._list({
            queryParams,
            path: (0, utils_js_1.makePathParams)('/v3/grants/{identifier}/events/import', {
                identifier,
            }),
            overrides,
        });
    ...
    find({ identifier, eventId, queryParams, overrides, }) {
        return super._find({
            path: (0, utils_js_1.makePathParams)('/v3/grants/{identifier}/events/{eventId}', {
                identifier,
                eventId,
            }),
            queryParams,
    ...
    sendRsvp({ identifier, eventId, requestBody, queryParams, overrides, }) {
        return this.apiClient.request({
            method: 'POST',
            path: (0, utils_js_1.makePathParams)('/v3/grants/{identifier}/events/{eventId}/send-rsvp', { identifier, eventId }),
            queryParams,
            body: requestBody,
            overrides,
        });
